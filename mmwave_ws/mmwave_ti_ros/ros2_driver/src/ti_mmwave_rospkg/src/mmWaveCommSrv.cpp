...
int main(int argc, char **argv)
{
    ...
    rclcpp::Service<ti_mmwave_rospkg_msgs::srv::MmwaveCli>::SharedPtr service = nodeptr2->create_service<ti_mmwave_rospkg_msgs::srv::MmwaveCli>("/ti_mmwave_rospkg_msgs/mmwave_cli", handle_service_request);
