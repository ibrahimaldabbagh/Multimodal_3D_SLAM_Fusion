...
def generate_launch_description():
 # rviz_arg = DeclareLaunchArgument('rviz', default_value='true', description='Enable RViz')
    ...
    mmWaveCommSrv = Node(
        ...
        emulate_tty=True,
        parameters=[
            {"command_port": "/dev/ttyXRUSB6"},
            {"command_rate": "115200"},
            {"data_port": "/dev/ttyXRUSB7"},
            {"data_rate": "921600"},
            {"frame_id": "ti_mmwave_3"},
    ...
    DataHandlerClass = Node(
        ...
        output="screen",
        remappings=[
            ('/ti_mmwave/radar_scan_pcl', '/ti_mmwave/radar_scan_pcl_3'),
        ],
        emulate_tty=True,
        parameters=[
            {"data_port": "/dev/ttyXRUSB7"},
    ...
    static_transform_publisher = Node(
        ...
        name="radar_baselink_3",
        arguments=["-0.04", "0", "0.08", "-1.0472",
                   "0", "0", "ti_mmwave_pcl", "ti_mmwave_3"]
    )
