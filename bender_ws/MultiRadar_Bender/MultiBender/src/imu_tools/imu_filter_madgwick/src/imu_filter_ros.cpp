      ...
      initialized_(false)
{
    ...
    declare_parameter("fixed_frame", "base_link"/*"odom"*/, descriptor);
    ...
    add_parameter(
        "gain", rclcpp::ParameterValue(0.03), float_range,
    ...
    // **** register publishers
    imu_publisher_ = create_publisher<sensor_msgs::msg::Imu>("imu/data_madg", 20);
    ...
    imu_subscriber_.reset(new ImuSubscriber(this, "imu/data", qos));
